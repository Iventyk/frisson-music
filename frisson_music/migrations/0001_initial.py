    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_type', models.CharField(choices=[('ANIME', 'Anime'), ('SERIES', 'Series'), ('GAME', 'Game'), ('MOVIE', 'Movie')], max_length=10)),
                ('media_title', models.CharField(max_length=255)),
                ('album_title', models.CharField(max_length=255)),
                ('cover_image_url', models.URLField()),
                ('part_or_season', models.CharField(default='Unknown', max_length=255)),
                ('release_date', models.CharField(default='Unknown', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='frisson_music.album')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='frisson_music.album')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
